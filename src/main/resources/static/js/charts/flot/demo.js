...
var updateInterval2 = 200, live2;
$("#flot-live2").length && ( live2 = $.plot("#flot-live2", [ getRandomData() ], {
    series: {
        lines: {
            show: true,
            lineWidth: 1,
...
function update2() {
    live2.setData([getRandomData()]);
    // Since the axes don't change, we don't need to call plot.setupGrid()
    live2.draw();
    setTimeout(update2, updateInterval2);
};

var updateInterval3 = 1000, live3;
$("#flot-live3").length && ( live3 = $.plot("#flot-live3", [ getRandomData() ], {
    series: {
        lines: {
            show: true,
            lineWidth: 1,
